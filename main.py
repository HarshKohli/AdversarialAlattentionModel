...
if __name__ == '__main__':
    ...
    primary_train_data, adverserial_train_data, dev_data, word_to_id_lookup, embeddings = data['primary_train_data'], \
                                                                                          data[
                                                                                              'adverserial_train_data'], \
                                                                                          data['dev_data'], data[
                                                                                              'word_to_id_lookup'], \
                                                                                          data['embeddings']
    ...
    model.train(sess, primary_train_data, adverserial_train_data, dev_data, word_to_id_lookup, config)
